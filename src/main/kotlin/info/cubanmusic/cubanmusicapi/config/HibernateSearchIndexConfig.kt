...
@Configuration
class HibernateSearchIndexConfig : ApplicationListener<ApplicationReadyEvent> {

    private val logger = LoggerFactory.getLogger(HibernateSearchIndexConfig::class.java)
