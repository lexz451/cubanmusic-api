...
interface OrganizationRepository : JpaRepository<Organization, UUID>, JpaSpecificationExecutor<Organization> {
    ...
    @Query("select o from Organization o")
    @Cacheable("organizations_public", unless = Utils.CACHE_RESULT_EMPTY)
    fun findAllPublic(): MutableList<Organization>
    ...
    @Caching(
        evict = [
            ...
            CacheEvict("organizations_public", allEntries = true)
        ],
        put = [
